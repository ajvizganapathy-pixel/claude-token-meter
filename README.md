...
Real-time Claude API token usage monitor — XIAO ESP32-S3 desk display with OLED, audio alerts, OTA updates, and web flasher.
...
1. Put XIAO in bootloader mode: hold **BOOT** → press **RESET** → release **BOOT**
2. Open `flasher/index.html` in Chrome or Edge
3. Select `firmware.bin`, click **Connect**, then **Flash Firmware**
